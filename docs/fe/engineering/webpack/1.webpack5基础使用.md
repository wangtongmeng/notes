...
- [@babel/@babel/core](https://www.npmjs.com/package/@babel/core)Babel编译的核心包，转ast语法树
...
+            plugins: [ // 不常用的单独加, 如果不需要参数可以写成1维的，例如 ["@babel/plugin-proposal-decorators", { legacy: true }] 变成 "@babel/plugin-proposal-decorators"
+              ["@babel/plugin-proposal-decorators", { legacy: true }], // legacy 老的， true，支持老写法 @dec class P，false 新语法 class @dec P
