...
![waterfall](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/waterfall2.jpg)

### 2.1 增量开发模型

- 增量模型是把待开发的软件系统模块化，将每个模块作为一个增量组件，从而分批次地分析、设计、编码和测试这些增量组件。

![aggregate](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/aggregate.jpg)

### 2.2 原型开发模型

原型模型指的是在执行实际软件的开发之前，应当建立系统的一个工作原型。

![prototype](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/prototype.jpg)
...
![UMLS](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/UMLS.jpg)
...
![usecase](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/usecase.png)
...
![dependency](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/dependency.png)

### 4.3.2 泛化关系(Generalization)

泛化关系实际上就是继承关系，他就是依赖关系的特例

![generalize](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/generalize.png)

### 4.3.3 实现关系(Implementation)

实现关系实际上就是A类实现B类，他就是依赖关系的特例

![implementation](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/implementation.png)
...
![associate](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/associate.png)
...
![aggregation](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/aggregation.png)
...
![compose](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/compose.png)
...
![activity](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/activity.png)
...
![sequence](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/sequence.png)
...
![collaborator](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/collaborator.png)
...
![componnet](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/componnet.png)
...
![componnet](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/deployee.png)